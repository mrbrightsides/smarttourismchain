...
postData.append('action', 'stcdrk_onchain');
...
document.querySelector('#stcdrk-booking-form').addEventListener('submit', async function (e) {
    e.preventDefault();
...
document.querySelector('#stcdrk-result').textContent = "Mohon tunggu, memproses...";
